...
focus=max(focus,0.2);
farblur=clamp(distance*0.003,0.0,0.99);//0.6 is maximum far blur amount
if(distance*0.1>1.9)dof=0.15; //2.0 is the distance of starting blur
else dof=0.0;
...
r0=r11 + r0 * 0.4; //FROM ORIGINAL CODE AFTER BLUR
...
r0=r7 * 0.05 + r0; //0.05 //TEMP DISABLED
//power from intensity
//dp3 r10, r0.xyz, c8.www //0.333
//dp3 r10, r0.xyz, c8.www
//r10=dot(r0.xyz, _c8.www);
r10=dot(r0.xyz, _c12.xyz); //luminance
//HERE 1.8 is brightness
r9.x=r10.x * 1.6;//c199.x;
//pow r9.x, r10.x, c10.y //c199.w
r10.x=1.0/r10.x;
r10=r10 * r9.x;
r0=r0 * r10.x;
...
r1.xyz=1.0/r1.xyz;
r0=r0 * r1;
//mul r0, r0, c8.z //post multiply
//texld r7, v0, s3 //bloom
...
float3 diffcolor2=r7.rgb-middlegray;
r0.rgb+=diffcolor*0.6;//saturation
//r7.rgb-=diffcolor*0.9*(r7*(1-pow(1.2,-r7*0.08)));
r0.rgb-=diffcolor*0.1;//
//float3 correctedcolor=saturate((0.99-r0*3.0*0.09)*1.04*0.0380537124869998527);
//r0.rgb=saturate(r0.rgb-correctedcolor)*1.0;
//	r0.rgb=pow(r0.rgb,0.8)*1.04;

float fRatio = 0.56;	// blend ratio (0-1)
float moodR = 0.45;	// mood color red component
float moodG = 0.4;	// mood color green component
float moodB = 0.3;	// mood color blue component
...
float   Defog=0.65;
float4  FogColor={0.01, 0.02, 0.01, 0.00}; // 
float4 FogColor2={0.09, 0.1, 0.02, 0.0};//
float   Exposure=0.08;
float   Gamma=0.80;
float   BlueShift=0.2;
